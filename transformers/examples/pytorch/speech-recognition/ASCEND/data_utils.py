...
class DataCollatorCTCWithPadding:
    ...
    def __call__(self, features: List[Dict[str, Union[List[int], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
        ...
        LID_features = [{"input_ids": feature["target_text_lid"]} for feature in features]
        ...
        batch["labels"] = labels
        batch["LID_labels"] = LID_batch["input_ids"].masked_fill(LID_batch.attention_mask.ne(1), -100)
        return batch